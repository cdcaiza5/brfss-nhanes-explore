...
An ACE score (sum of $11$ adverse-childhood-experience indicators) was considered as an engineered feature but was excluded from the final preset because the source ACE variables are almost entirely missing in the same rows, producing a near-constant score that added no signal %[cite: 1]. 
...
\hline
XGBoost             & \textbf{0.840} & \textbf{0.691} & 0.441 & 0.538 & 0.947 \\
\hline
